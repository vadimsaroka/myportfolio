...
// EXTERNAL MODULE: ./scss/projects.scss
var projects = __webpack_require__("8htM");

// EXTERNAL MODULE: ./node_modules/next/link.js
var next_link = __webpack_require__("YFqc");
var link_default = /*#__PURE__*/__webpack_require__.n(next_link);

// EXTERNAL MODULE: ./components/PortfolioContent.scss
var components_PortfolioContent = __webpack_require__("odTU");

// CONCATENATED MODULE: ./components/PortfolioContent.js




var PortfolioContent_PortfolioContent = function PortfolioContent(_ref) {
  var img = _ref.img,
      title = _ref.title,
  ...
  return external_react_default.a.createElement("figure", {
    ...
    className: "portfolio__mask"
  }, external_react_default.a.createElement("h4", null, title), external_react_default.a.createElement("p", {
    className: "portfolio__description"
  }, description), external_react_default.a.createElement(link_default.a, {
    as: "/details/".concat(link),
    href: "/details?link=".concat(link)
  }, external_react_default.a.createElement("a", {
    className: "portfolio__info"
  }, "View project"))));
};

/* harmony default export */ var components_PortfolioContent_0 = (PortfolioContent_PortfolioContent);
// CONCATENATED MODULE: ./pages/projects.js




var projects_baywood = function baywood() {
  return external_react_default.a.createElement("img", {
    src: "../static/baywood.jpg"
  });
};

var projects_royalfoodmarket = function royalfoodmarket() {
  return external_react_default.a.createElement("img", {
    src: "../static/royalfoodmarket.jpg"
  });
};

var projects_recipes = function recipes() {
  return external_react_default.a.createElement("img", {
    src: "../static/recipes.jpg"
  });
};

var projects_portfolio = function portfolio() {
  return external_react_default.a.createElement("img", {
    src: "../static/vadim.jpg"
  });
};
...
var projects_Portfolio = function Portfolio() {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement("section", {
    className: "portfolio"
  }, external_react_default.a.createElement("div", {
    className: "portfolio__heading"
  }, external_react_default.a.createElement("h4", null, "My Latest Work "), external_react_default.a.createElement("p", {
    className: "portfolio__text"
  }, "Take a look at some of my recent projects.")), external_react_default.a.createElement("div", {
    className: "portfolio__wrapper"
  }, external_react_default.a.createElement(components_PortfolioContent_0, {
    img: projects_baywood(),
    title: "Baywood Capital",
    description: "Node.js | JavaScript | Sass",
    link: "baywood"
  }), external_react_default.a.createElement(components_PortfolioContent_0, {
    img: projects_royalfoodmarket(),
    title: "Royal Food Market",
    description: "Node.js | JavaScript | Sass",
    link: "royalfoodmarket"
  }), external_react_default.a.createElement(components_PortfolioContent_0, {
    img: projects_recipes(),
    title: "Recipes2Fork",
    description: "Node.js | React.js | CCS",
    link: "recipes2fork"
  }), external_react_default.a.createElement(components_PortfolioContent_0, {
    img: projects_portfolio(),
    title: "My Portfolio",
...
/* harmony default export */ var pages_projects = __webpack_exports__["default"] = (projects_Portfolio);
