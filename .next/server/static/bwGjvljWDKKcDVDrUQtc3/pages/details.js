...
var components_Header = __webpack_require__("7jBW");
...
function (_React$Component) {
  ...
  function Header() {
    ...
    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Header).call(this));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "link", function () {
  ...
  Object(createClass["a" /* default */])(Header, [{
    ...
    value: function render() {
      ...
      }, "=VS="), this.link()), external_react_default.a.createElement("div", {
...
/* harmony default export */ var components_Header_0 = (Header_Header);
// EXTERNAL MODULE: ./components/Footer.scss
var components_Footer = __webpack_require__("JoS9");
...
var Footer_Footer = function Footer() {
  return external_react_default.a.createElement("footer", null, "Copyright \xA9 2019 by Vadim Saroka.");
};
...
var Layout_Layout = function Layout(props) {
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(components_Header_0, {
    links: links
  ...
  }), props.children, external_react_default.a.createElement("picture", {
  ...
  }))), external_react_default.a.createElement(components_Footer_0, null), external_react_default.a.createElement(style_default.a, {
    id: "1187757520"
...
// EXTERNAL MODULE: ./components/PortfolioDetails.scss
var components_PortfolioDetails = __webpack_require__("p8Wm");

// CONCATENATED MODULE: ./components/PortfolioDetails.js
...
var PortfolioDetails_PortfolioDetails =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(PortfolioDetails, _React$Component);

  function PortfolioDetails() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, PortfolioDetails);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(PortfolioDetails).call(this));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderContent", function (title) {
      if (title === "baywood") {
        return _this.renderBaywood();
      } else if (title === "royalfoodmarket") {
        return _this.renderRoyal();
      } else if (title === "recipes2fork") {
        return _this.renderRecipe();
      } else if (title === "portfolio") {
        return _this.renderPortfolio();
      }
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderBaywood", function () {
      if (_this.state.currentWidth < 1000) {
        return ["../static/baywood-medium.jpg", "../static/baywood-2-medium.jpg", "../static/baywood-3-medium.jpg", "../static/baywood-4-medium.jpg", "../static/baywood-5-medium.jpg"];
      } else {
        return ["../static/baywood.jpg", "../static/baywood-2.jpg", "../static/baywood-3.jpg", "../static/baywood-4.jpg", "../static/baywood-5.jpg"];
      }
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderRoyal", function () {
      if (_this.state.currentWidth < 1000) {
        return ["../static/royalfoodmarket-medium.jpg", "../static/royalfoodmarket-2-medium.jpg", "../static/royalfoodmarket-3-medium.jpg", "../static/royalfoodmarket-4-medium.jpg", "../static/royalfoodmarket-5-medium.jpg"];
      } else {
        return ["../static/royalfoodmarket.jpg", "../static/royalfoodmarket-2.jpg", "../static/royalfoodmarket-3.jpg", "../static/royalfoodmarket-4.jpg", "../static/royalfoodmarket-5.jpg"];
      }
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderRecipe", function () {
      if (_this.state.currentWidth < 1000) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderPortfolio", function () {
      if (_this.state.currentWidth < 1000) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "linkRendering", function (link) {
      if (link === "baywood") {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "currentImg", 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onButtonClick", function (title, btn) {
      var length = _this.renderContent(title).length;

      var currentImg = document.getElementsByClassName("portfolioDetail__img")[0];

      if (btn === "left" && length > 0) {
        _this.currentImg--;
        if (_this.currentImg < 0) _this.currentImg = length - 1;
      } else if (btn === "right" && length > 0) {
        _this.currentImg++;
        if (_this.currentImg > length - 1) _this.currentImg = 0;
      }

      _this.setState({
        currentLink: _this.renderContent(title)[_this.currentImg]
      });
  ...
  Object(createClass["a" /* default */])(PortfolioDetails, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("section", {
        className: "jsx-2520511" + " " + "portfolioDetail"
      }, external_react_default.a.createElement("div", {
        className: "jsx-2520511" + " " + "portfolioDetail__border"
      }, external_react_default.a.createElement("div", {
        className: "jsx-2520511" + " " + "portfolioDetail__wrapper"
      }, external_react_default.a.createElement("div", {
        className: "jsx-2520511" + " " + "portfolioDetail__top"
      }, external_react_default.a.createElement("div", {
        className: "jsx-2520511" + " " + "portfolioDetail__info"
      }, this.currentImg + 1, " /", " ", this.renderContent(this.props.title).length), external_react_default.a.createElement(link_default.a, {
        href: "/projects"
      }, external_react_default.a.createElement("a", {
        className: "jsx-2520511" + " " + "portfolioDetail__back"
      }, "\u2297"))), external_react_default.a.createElement("figure", {
        className: "jsx-2520511" + " " + "portfolioDetail__item"
      }, external_react_default.a.createElement("div", {
        onClick: function onClick() {
          return _this3.onButtonClick(_this3.props.title, "left");
        },
        className: "jsx-2520511" + " " + "portfolioDetail__left portfolioDetail__arrow"
      }, "\u276E"), external_react_default.a.createElement("img", {
        src: this.state.currentLink,
        alt: this.props.title,
        className: "jsx-2520511" + " " + "portfolioDetail__img"
      }), external_react_default.a.createElement("div", {
        onClick: function onClick() {
          return _this3.onButtonClick(_this3.props.title, "right");
        },
        className: "jsx-2520511" + " " + "portfolioDetail__right portfolioDetail__arrow"
      }, "\u276F")), external_react_default.a.createElement("a", {
        target: "_blank",
        rel: "noopener",
        "aria-label": "Learn more about this project",
        href: this.linkRendering(this.props.title)[0],
        className: "jsx-2520511" + " " + "portfolioDetail__link"
      }, this.linkRendering(this.props.title)[0]), external_react_default.a.createElement("a", {
        target: "_blank",
        rel: "noopener",
        "aria-label": "Learn more about this project",
        href: this.linkRendering(this.props.title)[1],
        className: "jsx-2520511" + " " + "portfolioDetail__link"
      }, this.linkRendering(this.props.title)[1]))), external_react_default.a.createElement(link_default.a, {
        href: "/projects"
      }, external_react_default.a.createElement("a", {
        "aria-label": "background",
        className: "jsx-2520511" + " " + "portfolioDetail__background"
      })), external_react_default.a.createElement("div", {
        id: "rotate",
        className: "jsx-2520511"
      }), external_react_default.a.createElement(style_default.a, {
        id: "2520511"
      }, [".portfolioDetail__background.jsx-2520511{background-image:url(../static/overlay.png);position:fixed;top:0;left:0;width:100%;height:100%;z-index:3;opacity:0.3;cursor:default;}", "@media (max-width:700px) and (orientation:portrait){#rotate.jsx-2520511{position:fixed;background:#212121 url(../static/rotate.jpg) no-repeat center;background-size:100% auto;top:0;left:0;right:0;bottom:0;z-index:10;display:block;}}"]));
    }
  }]);
...
/* harmony default export */ var components_PortfolioDetails_0 = (PortfolioDetails_PortfolioDetails);
// CONCATENATED MODULE: ./pages/details.js




var Details = Object(router_["withRouter"])(function (props) {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement(components_PortfolioDetails_0, {
    title: props.router.query.link
  }));
});
/* harmony default export */ var details = __webpack_exports__["default"] = (Details);
