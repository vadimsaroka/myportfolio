...
// EXTERNAL MODULE: ./components/ContactForm.scss
var components_ContactForm = __webpack_require__("2+pW");
...
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(ContactForm, _React$Component);

  function ContactForm() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, ContactForm);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(ContactForm).call(this));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderName", function () {
      if (!_this.state.nameVal) {
        return external_react_default.a.createElement("div", {
        ...
        }, external_react_default.a.createElement("p", null, "Please input name between 3 and 25 characters"));
      } else {
        return external_react_default.a.createElement("div", {
          className: "contact__success",
          style: {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderEmail", function () {
      if (!_this.state.emailVal) {
        return external_react_default.a.createElement("div", {
          className: "contact__success",
          style: {
            opacity: "0.7",
        ...
        }, external_react_default.a.createElement("p", null, "You have entered an invalid email address!"));
      } else {
        return external_react_default.a.createElement("div", {
          className: "contact__success",
          style: {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderSeccess", function () {
      if (_this.state.success) {
        ...
        }, external_react_default.a.createElement("p", null, "Your message was sent successfully. Thanks!"));
      } else {
        return external_react_default.a.createElement("div", {
          className: "contact__success",
          style: {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onChangeNameHandler", function (e) {
      _this.setState({
        name: e.target.value
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onChangeEmailHandler", function (e) {
      _this.setState({
        email: e.target.value
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onChangeMessageHandler", function (e) {
      _this.setState({
        message: e.target.value
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "submitBtn", function () {
      document.querySelector(".contact__btn").style.cursor = "pointer";
      document.querySelector(".contact__btn").removeAttribute("disabled");
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "nameValidation", function () {
      if (3 > _this.state.name.length || _this.state.name.length > 25) {
        _this.setState({
          nameVal: false
        });
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "emailValidation", function () {
      var mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;

      if (!_this.state.email.match(mailformat)) {
        _this.setState({
          emailVal: false
        });
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onSubmitHandler", function (e) {
      ...
      if (_this.state.nameVal && _this.state.emailVal && _this.state.name !== "" && _this.state.email !== "") {
        _this.setState({
          success: true,
          nameVal: true,
          emailVal: true
  ...
  Object(createClass["a" /* default */])(ContactForm, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var onRecaptchaLoad = setInterval(function () {
        grecaptcha.render("html_element", {
          sitekey: "6LfP1a0UAAAAAGBtKNL4mTqKPm49SpvHPu4RJNNw",
          callback: _this2.submitBtn
        });
    ...
    value: function render() {
      return external_react_default.a.createElement("div", {
      ...
      }, "Have a question or want to work together ?"), external_react_default.a.createElement("div", {
        className: "contact"
        ...
        placeholder: "Name"
      }), this.renderName(), external_react_default.a.createElement("label", {
        htmlFor: "email"
      ...
      }), this.renderEmail(), external_react_default.a.createElement("label", {
        htmlFor: "message"
      ...
      }), this.renderSeccess(), external_react_default.a.createElement("input", {
        type: "submit",
...
/* harmony default export */ var components_ContactForm_0 = (ContactForm_ContactForm);
...
var contact_Contact = function Contact() {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement(components_ContactForm_0, null));
};
