...
const AboutContent = ({ img }) => {
  return (
    <section className="about">
      <h5 className="about__header">Hi, it's nice to meet you!</h5>
      <h6 className="about__left--first">
        I'm a web developer based in San Francisco, CA.
      </h6>
      ...
      <div className="about__wrapper">
        <div className="about__left">
          ...
          <p className="about__text">
            HTML, CSS, SCSS, JS, building small web apps using React, Redux,
            responsive design, animations.
          </p>
          <p className="about__text">
            I also have full-stack developer experience with NodeJs, ExpressJs,
            MongoDB.
          </p>
          <p className="about__text">
            I enjoy each aspect, and have serious passion for building sites &
            web apps from start to finish.
          </p>
          <p className="about__text">
            For more information visit my{" "}
            <Link href="https://www.linkedin.com/in/vadim-saroka/">
              <a target="_blank" rel="noopener" className="about__link">
                <mark>LinkedIn</mark>
              </a>
            </Link>{" "}
            profile or just{" "}
